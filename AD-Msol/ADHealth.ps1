...
$smtphost = "SMTP.corporate.ncm" 
$from = "DoNotReply@ncm.com" 
$to = "Sysadmins@ncm.com"
$timeout = "60"
...
Add-Content $report "This script was executed from $env:computername using the $env:username service account"
